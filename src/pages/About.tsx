      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <h3 className="text-xl font-black mb-3">Passion for Fashion</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-black mb-3">Community First</h3>
            <p className="text-gray-600 font-medium">
        ...
        <div className="bg-gradient-to-r from-rose-500 to-pink-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-xl text-rose-100 mb-6 max-w-2xl mx-auto font-semibold">
